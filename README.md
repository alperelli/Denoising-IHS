...
* **Spectral_CT_Dataset**: this folder contains the Matlab functions to access and load the psectral CT dataset available at [Zenodo](https://doi.org/10.5281/zenodo.4482071) 
